<?php
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Cell(0,1,'SMART COMPUTER LAPORAN DATA BARANG','',0,'C',1); //TBLR (untuk garis)=> B = Bottom,
            // L = Left, R = Right
	...
	$pdf->Cell(3,1,'Gambar','LRTB',0,'C');
	 $pdf->Cell(3,1,'Kategori','LRTB',0,'C');
	  $pdf->Cell(3,1,'Produsen','LRTB',0,'C');
	   $pdf->Cell(3,1,'Harga Beli','LRTB',0,'C');
    $pdf->Cell(3,1,'Harga Jual','LRTB',0,'C');
    $pdf->Cell(2,1,'Stok','LRTB',0,'C');
	 $pdf->Cell(3,1,'Pemasok','LRTB',0,'C');
    $pdf->Ln();
