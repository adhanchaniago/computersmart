<?php
    ...
    $query ="SELECT tabel_penjualan.resi_penjualan, tabel_penjualan.tanggal, tabel_barang.nama_barang, tabel_penjualan.jumlah, 
...
tabel_karyawan.kode_karyawan = tabel_penjualan.kode_karyawan";
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Cell(0,1,'SMART COMPUTER LAPORAN DATA KARYAWAN','',0,'C',1); //TBLR (untuk garis)=> B = Bottom,
            // L = Left, R = Right
    ...
    $pdf->Cell(2,1,'Resi','LRTB',0,'C');
    $pdf->Cell(3,1,'Tanggal','LRTB',0,'C');
	$pdf->Cell(3,1,'Barang','LRTB',0,'C');
	 $pdf->Cell(3,1,'Jumlah','LRTB',0,'C');
	  $pdf->Cell(3,1,'Harga','LRTB',0,'C');
	   $pdf->Cell(3,1,'Total','LRTB',0,'C');
    $pdf->Cell(3,1,'Pelanggan','LRTB',0,'C');
    $pdf->Cell(3,1,'Karyawan','LRTB',0,'C');
    $pdf->Ln();
